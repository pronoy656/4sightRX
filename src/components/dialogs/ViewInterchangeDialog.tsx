...
import { X, TrendingDown, Pill, Tag } from "lucide-react";
import {
    Dialog,
    DialogContent,
    DialogHeader,
                ...
                <div className="p-8 pb-10 space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-1">
                            ...
                            <p className="text-slate-800 font-bold">{interchange.drugName}</p>
                        </div>
                        <div className="space-y-1">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-1">
                            <Label className="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-1.5">
                                <Tag className="h-3.5 w-3.5" /> Drug Class
                            </Label>
                            <p className="text-slate-700 font-semibold text-sm">{interchange.drugClass}</p>
                        </div>
                        <div className="space-y-1">
                            <Label className="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-1.5">
                                <Pill className="h-3.5 w-3.5" /> Dosage Equivalence
                            </Label>
                            <p className="text-slate-700 font-semibold text-sm">{interchange.dosageEquivalence || "N/A"}</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2 text-[#006FC9] font-bold text-lg">
                            ...
                            ${interchange.estimatedSavings}/year
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end pt-4">
                        <Button
                            className="h-12 px-8 bg-[#002D54] hover:bg-[#002B54]/90 rounded-xl text-white font-bold transition-colors shadow-lg shadow-blue-50"
